    ...
    if(!display) {
        ...
        <div className="row mb-4 d-flex flex-row bg-light gx-3 w-100">
            ...
            <div className="col-lg-6 col-8 align-content-center d-flex flex-wrap py-4">
                ...
                <Link to={`/earphones/${id}`} className="text-decoration-none text-white py-2 px-3 seepr">SEE PRODUCT</Link>
            </div>
        </div>
        </>
    }else {
...
const Earphones = function() {
    return <>
        <h1 className="p-5 w-100 text-center bg-dark text-white mb-4">EARPHONES</h1>
